...
function Header() {
  ...
  return (
    <div>
      <header className={` bg-white h-24 sm:h-32 flex items-center z-30 w-full fixed`}>
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center">
            <nav className="font-sen text-gray-800 uppercase text-lg lg:flex items-center hidden">
                ...
                <a href="/#home" className="py-2 px-6 flex hover:font-bold transition 40">Home</a>
             
  
                <a href="/#about" className="scroll-smooth duration-75 py-2 px-6 flex hover:font-bold transition 40">About</a>
            
              
                <a  href="/#contact" className="py-2 px-6 flex hover:font-bold transition 40">Contact</a>
